...
final public class StudentOperations {
    ...
    /**
     * @param classRoomsList list of class room.
    ...
    /**
     * @param id ID of class room to find out.
     * @param classRooms list of classroom.
     * @return
     */
    public List<List<String>> findSubjectByClassId(Integer id, List<ClassRoom> classRooms) {
        return classRooms.stream()
                ...
                .map(classRoom -> classRoom.studentList.get().parallelStream()
                        ...
                        .stream()
                        .map(student -> student.subjectList.get()))
                .flatMap(x -> x)
    ...
    /**
     * @param classRooms list of class room.
